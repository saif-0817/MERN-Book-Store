...
const ShowBook = () => {
  ...
  }, [id]); // Added `id` as a dependency to prevent ESLint warning
    ...
    <div className="p-4">
      ...
      {loading ? (
        ...
        <div className="flex flex-col border-2 border-sky-400 rounded-xl w-fit p-4">
          ...
          <div className="my-4">
            <span className="text-xl mr-4 text-grey-500">Publish Year</span> {/* Corrected label */}
            <span>{book.publishYear}</span>
          </div>
          <div className="my-4">
            <span className="text-xl mr-4 text-grey-500">Create Time</span>
            <span>{new Date(book.createdAt).toString()}</span> {/* Assuming there's a createdAt field */}
          </div>
          <div className="my-4">
